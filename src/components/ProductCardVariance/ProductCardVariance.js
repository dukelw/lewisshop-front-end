...
import styles from './ProductCardVariance.module.scss';
...
function ProductCardVariance({ data }) {
  ...
  const handleProductDetail = (ID) => {
    localStorage.setItem('productVarianceID', ID);
  };

  return (
    <div onClick={() => handleProductDetail(data._id)}>
      <Link to={`/shop/create/product-variants/${data.product_slug}`} className={cx('wrapper')}>
...
export default ProductCardVariance;
